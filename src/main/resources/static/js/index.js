    ...
    $.each(data, function (index, obj) {
        if(index != (data.length)){
            ...
            for(var i=0;i<obj['articleTags'].split(",").length;i++){

                var articleTag = $('<i class="am-icon-tag"><a class="tag" href="/tags?tag=' + obj['articleTags'].split(",")[i] + '"> ' + obj['articleTags'].split(",")[i] + '</a></i>');
